...
exports.userVerification = function(user, host) {
  ...
  var details = 'Please verify your account by clicking on the link below<br /><a href="http://' + host + '/verification/' + user._id + '/' + user.verificationToken + '">http://' + host + '/verification/' + user._id + '/' + user.verificationToken;
